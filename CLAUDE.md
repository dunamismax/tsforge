...
- **Scripts must be standalone.** Each script in `tools/` should be directly runnable with `python3 tools/<name>.py`. Import from `lib/` only when genuinely shared logic exists.
